...
Furthermore, the player data could have benefited from a facet as well, but because the time period variables were different between dataframes, 
it was difficult to work that out.
